...
// 契约和 [github.com/snight1983/ds-harness-go/harness/session.Session.Events] 逐字相同——**把它当只读的**，
...
// [github.com/snight1983/ds-harness-go/harness/session.Session.Append] 不碰调用方的值（负载的深复制发生
