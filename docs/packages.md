...
它还查一件跟本表无关、但同属「包和文档没各走各的」的事：**每个包的包注释末尾都要有一节「不做什么」**，把这个包不负责的事和各归谁写出来。一个包该干什么，读它的导出符号大致读得出来；**不该**干什么读不出来——那是当初做决定时排除掉的东西，不写下来就只活在写的人脑子里。标题是写死的，措辞一散门禁就没有判据了。
...
| `github.com/snight1983/ds-harness-go/feature/interaction/permissionpresets` | [用户交互](modules/interaction.md) |
...
| `github.com/snight1983/ds-harness-go/harness/harnesstest` | [Agent Loop](modules/agentloop.md) |
| `github.com/snight1983/ds-harness-go/harness/session` | [活会话](modules/livesession.md) |
| `github.com/snight1983/ds-harness-go/harness/smoketest` | [嵌入 Go 服务](embedding.md) |
...
| `github.com/snight1983/ds-harness-go/sessionlog/snapshot` | [LLM 测试与回放](modules/llm-testing.md) |
