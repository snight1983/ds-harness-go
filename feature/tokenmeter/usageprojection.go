...
func usageOf(event sessionlog.Event) (turn int, step int, usage llm.TokenUsage, present bool) {
	switch event.Type {
...
func applyTokenUsage(state tokenUsageState, event sessionlog.Event) (tokenUsageState, bool) {
...
func applyContextPressure(state contextPressureState, event sessionlog.Event) (contextPressureState, bool) {
