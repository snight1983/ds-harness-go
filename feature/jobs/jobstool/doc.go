...
// [github.com/snight1983/ds-harness-go/feature/jobs.Registry.AttachController]）：没有任何控制器服务的属主
...
//     上挂一项清理，做法和 [github.com/snight1983/ds-harness-go/adapter/localjobs] 那张属主表逐字相同。
//   - **每次调用的输出上限**是一张按 [github.com/snight1983/ds-harness-go/tools.ExecutionToken] 索引
//     的表。token 可比较、可当键，而 [github.com/snight1983/ds-harness-go/tools.Definition.FinalizeContent]
