...
// 挂上去。Go 里它是一条显式的规则链，和 [github.com/snight1983/ds-harness-go/tools] 那几道瀑布同一个
...
//
// 它的 [Service.Request] 就是 [github.com/snight1983/ds-harness-go/tools.Approval]，所以装好之后
// 可以直接交给工具运行时当审批后端。
type Service struct {
	policy Policy
...
//
// 新增: cordis 的作用域分派在 Go 里靠 [github.com/snight1983/ds-harness-go/scope.Layers] 表达，
// 做法和 tools 那几张规则表逐字相同。
...
// IsEmpty 实现 [github.com/snight1983/ds-harness-go/scope.Layer]。
...
//
// 落在哪一层由 owner 的身份决定：[github.com/snight1983/ds-harness-go/scope.NewRoot] 造的作用域落在
...
// Request 问一次，交出答复。它实现 [github.com/snight1983/ds-harness-go/tools.Approval]。
//
...
// [github.com/snight1983/ds-harness-go/tools.ApprovalOutcome] 是个开放的字符串类型，一条答复者写得出
// 任何值，而调用方那边是按四个常量分流的。
