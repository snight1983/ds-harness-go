...
//
// 验和改分成两步，和 [github.com/snight1983/ds-harness-go/feature/interaction/userapproval.Trace] 的做法一致：
...
func (t *Trace) resolves(event sessionlog.Event, data DoneData) bool {
