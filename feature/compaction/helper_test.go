...
func compactionStart(t *testing.T, seq int, data StartData) sessionlog.Event {
	t.Helper()
...
func compactionSummary(t *testing.T, seq int, data SummaryData) sessionlog.Event {
	t.Helper()
...
func compactionEnd(t *testing.T, seq int, data EndData) sessionlog.Event {
	t.Helper()
...
func replacementWithSource(t *testing.T, seq int, start, end int, source llm.MessageSource) sessionlog.Event {
	t.Helper()

	event := eventAt(seq, sessionlog.EventUserMessage, marshalPayload(t, sessionlog.UserMessageData{
		Message: llm.Message{
			ID:      llm.MessageID("c"),
			Role:    llm.RoleUser,
...
func checkpointReplacement(t *testing.T, seq int, start, end int, checkpoint CheckpointSource) sessionlog.Event {
	t.Helper()
...
func viewOf(generation int, events ...sessionlog.Event) SurfaceView {
