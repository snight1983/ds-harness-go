...
type installer struct {
	...
	overflowRetries map[sessionlog.SessionID]int
}
...
func (i *installer) retriesOf(id sessionlog.SessionID) int {
	i.mutex.Lock()
	defer i.mutex.Unlock()
...
func (i *installer) clearRetries(id sessionlog.SessionID) {
	i.mutex.Lock()
	defer i.mutex.Unlock()
