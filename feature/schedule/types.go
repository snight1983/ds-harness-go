...
const EventChange sessionlog.EventType = "schedule/change"

// EventTypes 是本包往会话词汇表里加的那些类型。
//
//	vocabulary := sessionlog.CoreVocabulary().With(schedule.EventTypes()...)
func EventTypes() []sessionlog.EventType { return []sessionlog.EventType{EventChange} }
...
// 落成**一个**带 Kind 判别的结构体，理由和 [github.com/snight1983/ds-harness-go/tools.Result] 上
