...
// 做法和 [github.com/snight1983/ds-harness-go/feature/compaction.CheckpointPlugin] 逐字相同。
//
...
// 交进来的 [github.com/snight1983/ds-harness-go/feature/skill.Registry] 自然满足它。窄口子让「本包到底看得见
...
// [Catalog] 相同；[github.com/snight1983/ds-harness-go/tools.Runtime] 自然满足它。
