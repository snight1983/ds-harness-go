...
func corruptGoalLog(t *testing.T, live *testAgent) {
	t.Helper()
	live.appendEvent(t, sessionlog.Event{Type: goal.EventChange, Data: json.RawMessage(`{"version":1}`)})
}
...
func TestOnSessionEventIgnoresWhatIsNotItsOwn(t *testing.T) {
	...
	events := []sessionlog.Event{
		...
		{Type: sessionlog.EventUserMessage, Data: json.RawMessage(`not json`)},
		{Type: sessionlog.EventAssistantChunk, Data: json.RawMessage(`{}`)},
		{Type: sessionlog.EventTurnEnd, Data: json.RawMessage(`not json`)},
		turnEndEvent(t, sessionlog.CompletedTurnEnd{}),
	}
...
func TestOnTurnEndDisarmsOnMaxTokens(t *testing.T) {
	...
	drive.onSessionEvent(turnEndEvent(t, sessionlog.MaxTokensTurnEnd{}))
...
func TestOnTurnEndMarksAnInflightRoundCancelled(t *testing.T) {
	...
	drive.onSessionEvent(turnEndEvent(t, sessionlog.AbortedTurnEnd{Reason: sessionlog.ParentCancel{}}))
