...
// 的耐久权威。
const EventChange sessionlog.EventType = "goal/change"

// EventTypes 是本包往会话词汇表里加的那些类型。
//
//	vocabulary := sessionlog.CoreVocabulary().With(goal.EventTypes()...)
...
// 原样携带它（成例见 [github.com/snight1983/ds-harness-go/feature/context/sessionref.Source]）。
//
