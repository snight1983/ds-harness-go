...
type Service struct {
	...
	// （成例见 [github.com/snight1983/ds-harness-go/feature/guard/repeattoolreminder]）——一个用完就不再有人
...
func (s *Service) commit(
	...
	_, appendErr := owned.Append(sessionlog.Event{Type: EventChange, Data: data})
	if appendErr == nil {
