...
// blockCode 是模型自报阻塞时落进 [github.com/snight1983/ds-harness-go/feature/goal.BlockReason] 的那个分类。
//
...
// Go 的 [github.com/snight1983/ds-harness-go/feature/goal.CreateRequest.MaxGoalRounds] 是 *int，装不下 2.5，
...
// [github.com/snight1983/ds-harness-go/feature/schedule.safeInteger]：JS 那边 3.0 和 3 是同一个数，
...
// 不一样的话。理由同 [github.com/snight1983/ds-harness-go/feature/goal.marshalNoEscape]。
//
...
// [github.com/snight1983/ds-harness-go/feature/goal.Activation]），交给模型只是为了让它知道这个目标此刻
// 会不会自己往下推。
func goalValue(view *goal.View) goalWire {
	...
	if view.BlockedReason != nil {
		// 复制一份再交出去：[github.com/snight1983/ds-harness-go/feature/goal.View] 里那是一个导出的指针，
...
// [github.com/snight1983/ds-harness-go/tools.Node] 按 JSON Schema 本来的样子写在对象上（Required）。
// 两边表达的是同一件事。
