...
// 那两个方法（窄口子的理由同 [github.com/snight1983/ds-harness-go/feature/goal.Agents]）：一个回答「我手里
...
// [github.com/snight1983/ds-harness-go/feature/goal.Service] 自然满足它（窄口子的理由同
// [github.com/snight1983/ds-harness-go/feature/subagent/controltool.Service]）。少掉的两个是
// [github.com/snight1983/ds-harness-go/feature/goal.Service.Clear] 和 Disarm：那两条路归**生命周期持有者**
...
type Config struct {
	...
	//
	// 和 [github.com/snight1983/ds-harness-go/feature/jobs/jobstool.Config.AgentOf] 不一样的是**查不回来就是错**：
