...
// [github.com/snight1983/ds-harness-go/feature/subagent/subagenttool.Subagents]）。
//
...
type Config struct {
	...
	// 所以由装配方交一条查回去的路，做法和
	// [github.com/snight1983/ds-harness-go/feature/subagent/subagenttool.Config.AgentOf] 逐字相同。
	//
...
// [github.com/snight1983/ds-harness-go/feature/subagent/subagenttool.Controller] 不同——那台要在提供方来来去去
