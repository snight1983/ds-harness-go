...
func (e *Engine) ReadTitleSnapshot(ctx context.Context, id sessionlog.SessionID) (TitleObservation, error) {
	results, err := e.ReadTitleSnapshots(ctx, []sessionlog.SessionID{id})
	if err != nil {
		return TitleObservation{}, err
	}
	if len(results) == 0 {
...
func (e *Engine) ReadTitle(ctx context.Context, id sessionlog.SessionID) (sessiontitle.Snapshot, bool, error) {
