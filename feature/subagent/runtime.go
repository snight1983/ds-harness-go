...
type Runtime struct {
	...
	// [github.com/snight1983/ds-harness-go/harness/agent.Registry] 逐字相同：一个观察者反手来问
...
func assertCapabilities(provider Provider, request StartRequest) error {
	...
	needs := []struct {
		...
		// [github.com/snight1983/ds-harness-go/tools.Restriction] 是值类型，没有「不在」，所以
...
// 的部署同理，它不可能攥着任何活化。
func (r *Runtime) Interrupt(targetSessionID sessionlog.SessionID, authority InterruptAuthority) error {
	if r.continuations == nil {
		return nil
	}
...
func (r *Runtime) ListChildren(ctx context.Context, parentSessionID sessionlog.SessionID) ([]ListEntry, error) {
...
func (r *Runtime) ListDescendants(ctx context.Context, rootSessionID sessionlog.SessionID) ([]DescendantListEntry, error) {
