...
type ActivationSetupRegistry struct {
	...
	// [github.com/snight1983/ds-harness-go/scope.AnonymousEntries] 正是这样东西，而且它的 Values
...
//
// 新增: 它的签名**恰好**就是 [github.com/snight1983/ds-harness-go/harness/agent.Setup]，所以这个方法值可以
...
// （成例见 [github.com/snight1983/ds-harness-go/harness/agentloop] 那次收尾）。
