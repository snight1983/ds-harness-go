...
// [github.com/snight1983/ds-harness-go/harness/agent.Options] 是闭合结构体，贴不上；那份深度改走
// [github.com/snight1983/ds-harness-go/harness/agent.CreateOptions.DelegationDepth] 写进会话头，
...
// [github.com/snight1983/ds-harness-go/harness/agent.CreateOptions] 把那层嵌套摊平了，所以这里交回的是一份
...
// （成例见 [github.com/snight1983/ds-harness-go/feature/interaction/userapproval.NeverStatement]）。
...
// [github.com/snight1983/ds-harness-go/harness/systemprompt.NewRegistry] 里那几笔自己的登记）。
...
type DelegatedPolicyOverrides struct {
	...
	// [github.com/snight1983/ds-harness-go/feature/interaction/userapproval.PolicyNever]，否则是空串：一个被派发的
