...
type childLock struct {
	...
	held map[sessionlog.SessionID]chan struct{}
}

// newChildLock 造一把空锁。
func newChildLock() *childLock {
	return &childLock{held: map[sessionlog.SessionID]chan struct{}{}}
}
...
func (l *childLock) acquire(ctx context.Context, childID sessionlog.SessionID) (func(), error) {
	for {
		l.mutex.Lock()
...
func (l *childLock) release(childID sessionlog.SessionID) {
	l.mutex.Lock()
