...
// [github.com/snight1983/ds-harness-go/feature/plan/planmode]）。不调的后果是 [Runtime.ListChildren] 分不出孩子的
// 耐久身份。
//
...
//     （[github.com/snight1983/ds-harness-go/harness/agent.FoldConsumedWork] 先解过同一段），以及
