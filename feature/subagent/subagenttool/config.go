...
// [github.com/snight1983/ds-harness-go/harness/systemprompt.PromptSection.Order] 是 int，116 和 117 之间
// 没有空位，所以这里取 117，并把
// [github.com/snight1983/ds-harness-go/feature/subagent/reporttool.SectionOrder] 顺推到 118。次序这件事只有
...
const (
	...
	//
	// 它要提供方实现 [github.com/snight1983/ds-harness-go/feature/subagent.ContinuablePreparer]，
	// 装不上就大声失败。
...
// [github.com/snight1983/ds-harness-go/feature/subagent.Runtime] 自然满足它（窄口子的理由同
...
type Config struct {
	...
	//
	// 这里**查不回来就是错**（和 [github.com/snight1983/ds-harness-go/feature/jobs/jobstool.Config.AgentOf]
	...
	// [github.com/snight1983/ds-harness-go/tools.Options.Logger]。
	Logger *slog.Logger
...
// 形状和 [github.com/snight1983/ds-harness-go/feature/jobs/jobstool.Deps] 一致。
type Deps struct {
	// Tools 是工具运行时，必填。
	Tools *tools.Runtime
