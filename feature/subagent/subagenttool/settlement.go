...
// 这几句是一个非 [github.com/snight1983/ds-harness-go/feature/subagent.StopCompleted] 的终止原因给模型的
// 那句话头。
//
...
// [github.com/snight1983/ds-harness-go/feature/jobs.Hooks.Done] 只收结局，不收错误。
//
...
// 而不是 [context.Canceled]（成例见 [github.com/snight1983/ds-harness-go/protocol/mcp.Host] 和
// [github.com/snight1983/ds-harness-go/harness/systemprompt.Registry]），而 [context.WithCancelCause] 带的
