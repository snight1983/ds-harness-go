...
//
// 第三层比前两层晚落地：它要一个活的 [github.com/snight1983/ds-harness-go/harness/session.Session]
...
// 实现在 [github.com/snight1983/ds-harness-go/adapter/datastore/sessionstore]，
// 换别的介质就自己实现 [Backend]。本包给出的是那道缝。
//
// 本包**不知道**下面是什么介质，也不该知道：数据库那一摊整个收在 datastore 底下，
// 这条界线由 internal/devtools/dbcheck 把着。
//
// # 覆盖率为什么到不了 99%
//
