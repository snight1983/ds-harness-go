...
// [github.com/snight1983/ds-harness-go/feature/todo.RegisterProjection]）。[Controller.Install] 在
...
func applyProjection(state unitState, event sessionlog.Event) (unitState, bool) {
	switch event.Type {
