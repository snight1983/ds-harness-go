...
// 违例，和 [github.com/snight1983/ds-harness-go/feature/todo.ValidateEvent] 一致：它因此可以脱离不变量注册表
...
// [github.com/snight1983/ds-harness-go/feature/todo] 那份同名帮手一致——"undefined" 是一句只有 JS 读者才认得的话。
