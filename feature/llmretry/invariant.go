...
//
// 分成「验」和「落」两步，理由和 [github.com/snight1983/ds-harness-go/feature/compaction.Transition] 逐字相同。
//
// 新增: 字段全不导出。[github.com/snight1983/ds-harness-go/feature/interaction/userapproval.Transition] 那边导出了
...
// 违例，和 [github.com/snight1983/ds-harness-go/sessionlog.Trace.Validate] 一致——它因此可以脱离不变量注册表
...
//     而 0 在 Go 这边正是缺席本身。
func validateFailure(seq int, kind sessionlog.EventType, failure llm.Failure) error {
	fail := func(format string, args ...any) error {
...
//
// 源: packages/llm/llm-retry/src/invariant.ts:52-56
func (t *Trace) Apply(_ sessionlog.Event, transition Transition) {
...
// [github.com/snight1983/ds-harness-go/feature/interaction/userapproval.RegisterInvariants] 逐字相同。
