...
// 装配方交进来的 [github.com/snight1983/ds-harness-go/sessionquery.Engine] 自然满足它。窄口子的好处是
...
type Config struct {
	...
	// [github.com/snight1983/ds-harness-go/core/tools.Definition.Timeout]，由工具运行时统一执行——那件事
