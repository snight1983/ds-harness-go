...
func (r *stubAgents) Get(id sessionlog.SessionID) (agent.Agent, bool) {
	live, ok := r.live[id]
	return live, ok
}
...
func newCluster(t *testing.T) *cluster {
	...
	return &cluster{
		...
		agents: &stubAgents{live: map[sessionlog.SessionID]agent.Agent{}},
	}
}
...
func (c *cluster) newOwner(id sessionlog.SessionID) *stubAgent {
	c.t.Helper()
