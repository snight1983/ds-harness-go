...
func compactionStart(t *testing.T, seq int, turn int) session.Event {
	t.Helper()
...
func compactionEnd(t *testing.T, seq int, turn int) session.Event {
	t.Helper()
...
func toolResult(t *testing.T, seq int, index int) session.Event {
	t.Helper()
...
func viewOf(events ...session.Event) compaction.SurfaceView {
