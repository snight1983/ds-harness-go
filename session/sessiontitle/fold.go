...
func CollectMessages(events []session.Event, throughSeq int) []UserMessage {
...
func titleTextOf(event session.Event) (string, bool) {
...
func FoldSnapshot(events []session.Event) (Snapshot, bool, error) {
