...
// [github.com/snight1983/ds-harness-go/jobs/localjobs.Config]，
// 这样两台实现在装配处是可以对着换的。
...
// github.com/snight1983/ds-harness-go/jobs/jobstool），它的等待预算按秒算，
...
//
// 形状和 [github.com/snight1983/ds-harness-go/jobs/localjobs.Agents] 逐字相同：
