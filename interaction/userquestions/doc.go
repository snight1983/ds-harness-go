...
// # 面向模型的那件工具不在这儿
//
// ask_user_question 那件工具在 [github.com/snight1983/ds-harness-go/interaction/askuser]。本包只有接缝，
...
// 作用域键（[github.com/snight1983/ds-harness-go/core/scope.Key]），活 agent 注册表是循环那一块的东西，
...
// ErrorCode 两个方法，于是 [github.com/snight1983/ds-harness-go/core/tools] 那道结果收敛能把它的身份
