...
//
// 它和 [github.com/snight1983/ds-harness-go/mcp.Config] 那边卡的形状是同一条，两边
...
// Go 里对应的是 [github.com/snight1983/ds-harness-go/mcp.Host.Connect] 收一个宿主作用域，
// 拆除同样由那个作用域管。这里照本包 [Peer]、[ModelResolver] 的成例收窄成一个方法，
// 交进来的 [github.com/snight1983/ds-harness-go/mcp.Host] 自然满足它。
...
// [github.com/snight1983/ds-harness-go/mcp] 整个只有 Streamable HTTP 一条传输，因为
