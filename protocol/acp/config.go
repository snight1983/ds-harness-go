...
// [github.com/snight1983/ds-harness-go/protocol/sdk/sdkserver.LLMService]），
...
// [github.com/snight1983/ds-harness-go/feature/subagent.Runtime] 满足它。
...
// 瀑布是 [github.com/snight1983/ds-harness-go/feature/interaction/userapproval.Service.RegisterAnswerer] 的一条显式
// 规则链，这里只取那一个方法。它可以为 nil：这条线上没挂审批服务，那么这座桥就不
// 参与拍板。
//
// 签名里的答复者类型必须是具名的 [github.com/snight1983/ds-harness-go/feature/interaction/userapproval.Answerer]，
...
// 这里照本包的成例收窄成一个方法，
// [github.com/snight1983/ds-harness-go/feature/persistence.Coordinator] 自然满足它。
//
...
// [github.com/snight1983/ds-harness-go/protocol/sdk/sdkserver.Config] 上那条逐字相同。
//
...
type Config struct {
	...
	// 两条接缝。Go 的
	// [github.com/snight1983/ds-harness-go/harness/agent.InstallModelSelection] 两张注册表
...
// [github.com/snight1983/ds-harness-go/protocol/sdk/sdkserver.Config] 不同），它由 [Bridge.Install] 收。这个环是协议
