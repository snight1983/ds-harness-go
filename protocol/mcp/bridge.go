...
// 靠 GC 回收。Go 没有 WeakMap，但 [github.com/snight1983/ds-harness-go/tools.ExecutionToken] 本来
...
// 于是它走回滚那条路。Go 这边 schema 要先解成 [github.com/snight1983/ds-harness-go/tools.Node] 才造得出
...
// 由注册表在登记时验。Go 的 [github.com/snight1983/ds-harness-go/tools.Definition.Parameters] 是
