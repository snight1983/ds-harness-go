...
// 握手、关联和续传——那正是「移植时用 Go 现成的办法，不要照录别人造的轮子」要避免的。
...
// 模型、那个模型收不收图」。Go 这边 [github.com/snight1983/ds-harness-go/tools.ExecutionInput.Agent]
...
//     [github.com/snight1983/ds-harness-go/tools.Runtime] 交回来的那个函数，本包自己注册进去的
